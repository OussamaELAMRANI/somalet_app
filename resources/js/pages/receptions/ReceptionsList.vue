        ...
        <div class="row">
            <div class="col-9 m-0 pr-0">
                ...
                <div class="list-arrival-content">
                    ...
                    <div v-else class="row segment align-items-center justify-content-center" v-for="(c,index) in searchArrivals"
                         :key="index"
                         :id="c.id">
                                    ...
                                    <tr v-for="p in c.product">
                                        ...
                                        <td>
                                            <input type="text" class="form-control"
                                                   placeholder="tapez ici la quantite ...">
                                        </td>
                                        <td>
                                            <input type="text" class="form-control"
                                                   placeholder="tapez ici votre remarque ...">
                                        </td>
                                    </tr>
                                    </tbody>
