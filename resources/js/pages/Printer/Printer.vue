<template>
    <div>
       ...
       <button @click="printCmd"
               class="btn btn-primary text-uppercase text-white font-weight-bolder float-right btn-block ">Imprimer BC
       </button>
        <div id="printBL-a">
       ...
       <!-- OUTPUT -->
       <button @click="printA"
               class="btn btn-primary text-uppercase text-white font-weight-bolder float-right btn-block ">Imprimer BL (A)
       </button>
        <div id="printBL-b">
            <div class="container mt-5">
                <table class="table table-bordered  table-sm table-striped">
       ...
       <!-- OUTPUT -->
       <button @click="printB"
               class="btn btn-primary text-uppercase text-white font-weight-bolder float-right btn-block ">Imprimer BL (B)
       </button>
...
<script>
    export default {
        ...
        methods: {
           ...
           printA() {
                this.$htmlToPaper('printBL-a');
            },
           printB() {
                this.$htmlToPaper('printBL-b');
            },
        }
    }
</script>
